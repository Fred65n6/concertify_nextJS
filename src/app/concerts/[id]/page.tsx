            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-6">
                <figure>
                    <Image
                        ...
                        // height={200}
                        alt="concert"
                        className="h-auto w-fit rounded-lg"
                    />
                </figure>
                <section>
                    ...
                    <ul className="flex flex-col gap-4">
                        ...
                        <li className="flex gap-2">
                            <Image
                                ...
                                />
                            <p className="text-gray-600 text-sm dark:text-gray-400 align-middle">
                                <span className="font-bold">Doors open: </span>19:00
                            </p>
                        </li>
                        ...
                        <li className="flex gap-2">
                            <Image
                                ...
                                />
                            <p className="text-gray-600 text-sm dark:text-gray-400 align-middle">
                                <span className="font-bold">Concert starts: </span>20:00
                            </p>
                        </li>
                    ...
                    <div className="border-t-[1px] border-[#979C9E] pt-4 mt-4">
                        <p className="text-gray-600 text-sm dark:text-gray-400 align-middle">Beyoncé has spent over two decades dominating the music industry. She is the most-awarded artist in Grammy history with 32 wins, and has sold 200 million albums worldwide, earning eight Billboard No. 1 hits. As a live performer, Beyoncé’s dynamic stage presence and choreography are unparalleled. Her iconic world tours, including two co-headlining tours with Jay-Z (On the Run Tour I and II), have grossed $767.3 million and sold 8.9 million tickets. In 2018, she became the first Black woman to headline Coachella, and her performance (dubbed “Beychella”) is considered one of the festival’s most memorable and record-breaking moments.</p>
                    </div>
